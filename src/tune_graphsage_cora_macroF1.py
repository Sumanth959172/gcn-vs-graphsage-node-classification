...
def main():
    ...
    # Cora: train longer + more patience
    max_epochs = 2000
    patience = 200
    min_delta = 1e-4
    ...
    # Cora-optimized search space (often prefers smaller dims + slightly higher lr)
    space = {
    ...
    out_dir = "experiments/tune_cora_graphsage_macroF1"
    ...
    # Feature normalization (consistent with your project)
    x = data.x
