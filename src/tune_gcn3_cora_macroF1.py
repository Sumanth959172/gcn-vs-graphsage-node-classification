...
def main():
    ...
    # Cora: train longer + more patience (small data, noisier validation)
    max_epochs = 2000
    patience = 200
    min_delta = 1e-4
    ...
    # -----------------------------
    # Cora-optimized search space
    # -----------------------------
    # Typical Cora sweet spots are smaller than PubMed:
    # - hidden_dim ~ 64-256
    # - lr ~ 0.005-0.02
    # - weight_decay often 5e-4 or 1e-3 (sometimes 0)
    space = {
    ...
    out_dir = "experiments/tune_cora_gcn3_macroF1"
    ...
    # Feature normalization (keep consistent across your project)
    x = data.x
