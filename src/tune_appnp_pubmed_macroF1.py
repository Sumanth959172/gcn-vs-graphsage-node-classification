...
def main():
    ...
    # PubMed-friendly APPNP space
    # Typical good ranges: K=10..20, alpha=0.1..0.2
    space = {
    ...
    out_dir = "experiments/tune_pubmed_appnp_macroF1"
    ...
    # Feature normalization (consistent across project)
    x = data.x
