...
def main():
        ...
        for model_name in ["GCN", "GraphSAGE"]:
            for drop_p in drop_levels:
                ...
                for seed in seeds:
                    ...
                    data = apply_edge_dropout(clean_data, drop_p)
                ...
                s = result["summary"]
                print(
                    f"[{dataset_name}] {model_name} edge_drop={drop_p:.1f} | "
    ...
    meta = {
        "experiment": "edge_dropout_robustness",
